import { registerTranscriberPushSubscription, unregisterTranscriberPushSubscription, type TranscriberAuthProfile } from "./api";
...
export async function syncWebPushRegistration(): Promise<boolean> {
  ...
  await withTimeout(
    registerTranscriberPushSubscription(subscriptionPayload(subscription)),
...
export async function enableWebPush(_profile: TranscriberAuthProfile): Promise<"enabled" | "unsupported" | "denied" | "disabled"> {
...
export async function disableWebPush(): Promise<void> {
  ...
  await unregisterTranscriberPushSubscription({
    endpoint: subscription.endpoint,
    keys: {
