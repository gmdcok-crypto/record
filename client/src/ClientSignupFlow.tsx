        ...
        <div className="terms-list">
          ...
          <div className="terms-item">
            ...
            {!expanded.privacy ? null : (
              <div className="terms-body" id="client-terms-body-privacy">
                <p>
          ...
          <div className="terms-item">
            ...
            {!expanded.collection ? null : (
              <div className="terms-body" id="client-terms-body-collection">
                <p>
...
export default function ClientSignupFlow({ open, onClose, onSuccess }: Props) {
  ...
  return (
    <>
      ...
      />
      <SignupModal open={signupOpen} onClose={closeAll} onSuccess={handleSuccess} />
    </>
  );
}
